...
<div id="carouselMenu" class="carousel slide" data-interval="200" data-wrap="true">
	...
	<div class="carousel-inner"> 
		<div class="item active"><img src="images/ad/ads-pic-01.jpg" alt="f1Img"></div>
		<div class="item"><img src="images/ad/ads-pic-02.jpg" alt="f2Img"></div>
		<div class="item"><img src="images/ad/ads-pic-03.jpg" alt="f3Img"></div>
		<div class="item"><img src="images/ad/ads-pic-04.jpg" alt="f4Img"></div>
		<div class="item"><img src="images/ad/ads-pic-05.jpg" alt="f5Img"></div>
	</div>
	<!-- 轮播（Carousel）导航 -->
