...
<%!
    ...
    public static final String EMP_ADD_URL = "pages/back/admin/emp/member_add.jsp";
    public static final String EMP_LIST_URL = "pages/back/admin/emp/member_list.jsp";
